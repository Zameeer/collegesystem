...
<div class="content">
	...
	<div class="table">
		<div class="table-header">
			...
			<div class="header__item">LAB_ID</div>
			
			<div class="header__item">Mouse</div>
      <div class="header__item">Monitor</div>
      <div class="header__item">CPU</div>
      <div class="header__item">Keyboard</div>
      <div class="header__item">Printer</div>
		</div>
    ...
    if($con->connect_error) {
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
         ...
         <div class='table-data'>" . $row["lab_id"]. "</div>
         <div class='table-data'>" . $row['mouse']. "</div>
         <div class='table-data'>" . $row['monitor']. "</div>
         <div class='table-data'>" . $row['cpu']. "</div>
         <div class='table-data'>" . $row['keyboard']. "</div>
         <div class='table-data'>" . $row['printer']. "</div>
         </div>";
        }
      } else {
        echo "0 results";
